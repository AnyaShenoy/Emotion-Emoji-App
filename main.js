...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/WsjOi57Mt/model.json',modelLoaded)
...
function gotResults(error,results){
    if(error){
        ...
        if(results[0].label=="Anxious/Pensive"){
        ...
        if(results[1].label=="Anxious/Pensive"){
